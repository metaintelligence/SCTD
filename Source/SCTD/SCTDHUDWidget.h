...
private:
	...
	TSharedPtr<SSCTDMarqueeText> HealthText;
	TSharedPtr<SSCTDMarqueeText> BoostText;
	TSharedPtr<SSCTDMarqueeText> ModeText;
	TSharedPtr<SSCTDMarqueeText> TargetText;
	TSharedPtr<SSCTDMarqueeText> ScrapText;
	TSharedPtr<SSCTDMarqueeText> DefenseTimeText;
	TSharedPtr<SSCTDMarqueeText> MonsterCountText;
	TSharedPtr<SSCTDMarqueeText> LevelText;
	TSharedPtr<SSCTDMarqueeText> ConstructionText;
