...
DEATH_ANIMATION_PATH = "/Game/Fab/Zombie_Number_4_-_Animated/zom_4/SkeletalMeshes/zom_4Stumble.zom_4Stumble"
...
death_animation = unreal.EditorAssetLibrary.load_asset(DEATH_ANIMATION_PATH)
...
if not death_animation:
    raise RuntimeError(f"Missing death animation: {DEATH_ANIMATION_PATH}")
